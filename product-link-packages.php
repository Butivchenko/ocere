                ...
                <form method="post" action="place_order.php" enctype="multipart/form-data">
                    <div class="row">
                        <div class="col-md-8 col-md-offset-2">
                            ...
                            <input type="hidden" name="page" value="Link Packages">

                            <div class="form-group">
                                <label for="sel1">Choose option:</label>
                                <select name="select" class="form-control" id="sel1">
                                    <option>Link Package 1 - $395 / £295</option>
                                    <option>Link Package 2 - $695 / £495</option>
                                    <option>Link Package 3 - $1295 / £895</option>
                                    <option>Link Package 4 - $1995 / £1495</option>
                                    <option>Link Package 5 - $3495 / £2595</option>
                                    <option>Link Package 6 - $4995 / £3795</option>
                                    <option>Link Package 7 - $7495 / £5795</option>
                                    <option>Link Package 8 - $9995 / £7795</option>
                                </select>
                            </div>
